...
INT CLcXSkinSrc::Create(void* p1, void* p2, void*, void* )
{
	...
	hr = D3DXLoadMeshHierarchyFromX(m_sFile
								, D3DXMESH_MANAGED
								, m_pDevice
								, &Alloc
								, NULL
...
INT CLcXSkinSrc::SetAttrib(char* sCmd, void* pVal)
{
	if(0 ==_stricmp(sCmd, "Method"))
 	{
	...
	return CLcXSkin::SetAttrib(sCmd, pVal);
}

INT CLcXSkinSrc::GetAttrib(char* sCmd, void* pVal)
{
	if(0 ==_stricmp(sCmd, "Radius"))
 	{
 		*((FLOAT*)pVal) = m_ObjectRadius;
 		return 0;
 	}
	else if(0 ==_stricmp(sCmd, "Center"))
 	{
 		*((D3DXVECTOR3*)pVal) = m_ObjectCenter;
 		return 0;
 	}

	else if(0 ==_stricmp(sCmd, "Method"))
 	{
 		*((INT*)pVal) = GetMethod();
 		return 0;
 	}

	return CLcXSkin::GetAttrib(sCmd, pVal);
}
