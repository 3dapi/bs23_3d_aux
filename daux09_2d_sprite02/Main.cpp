...
//	RenderXYZ();
...

	{
		...
		m_pLcSprite->Draw(m_pTex0->GetTexture(), &rcDrw, (FLOAT*)&vcPos, color);
		...
		m_pd3dSprite->Draw((LPDIRECT3DTEXTURE9)m_pTex0->GetTexture(), &rcDrw, NULL, &t, color);
		m_pd3dSprite->End();
...

	{
		...
		m_pLcSprite->Draw(m_pTex1->GetTexture(), &rcDrw, (FLOAT*)&vcPos, D3DXCOLOR(1, 0, 1, 1.F));
		...
		m_pd3dSprite->Begin(D3DXSPRITE_ALPHABLEND);
		m_pd3dSprite->Draw((LPDIRECT3DTEXTURE9)m_pTex1->GetTexture(), &rcDrw, NULL, &t, D3DXCOLOR(1,1,1,1));
		m_pd3dSprite->End();
