...
// Desc: 
//-----------------------------------------------------------------------------
CD3DEnumeration::D3DAdapterInfo::~D3DAdapterInfo()
{
    ...
    if( pDeviceInfoList != NULL )
    {
        for( UINT idi = 0; idi < pDeviceInfoList->Count(); idi++ )
            delete (CD3DEnumeration::D3DDeviceInfo*)pDeviceInfoList->GetPtr(idi);
...
// Desc: 
//-----------------------------------------------------------------------------
CD3DEnumeration::D3DDeviceInfo::~D3DDeviceInfo()
{
    if( pDeviceComboList != NULL )
    {
        for( UINT idc = 0; idc < pDeviceComboList->Count(); idc++ )
            delete (CD3DEnumeration::D3DDeviceCombo*)pDeviceComboList->GetPtr(idc);
...
// Desc: 
//-----------------------------------------------------------------------------
CD3DEnumeration::D3DDeviceCombo::~D3DDeviceCombo()
{
...
CD3DEnumeration::~CD3DEnumeration()
{
    if( m_pAdapterInfoList != NULL )
    {
        for( UINT iai = 0; iai < m_pAdapterInfoList->Count(); iai++ )
            delete (CD3DEnumeration::D3DAdapterInfo*)m_pAdapterInfoList->GetPtr(iai);
...
//-----------------------------------------------------------------------------
HRESULT CD3DEnumeration::EnumerateDevices( CD3DEnumeration::D3DAdapterInfo* pAdapterInfo, 
                                           CArrayList* pAdapterFormatList )
{
    ...
    CD3DEnumeration::D3DDeviceInfo* pDeviceInfo = NULL;
    for( UINT idt = 0; idt < devTypeArrayCount; idt++ )
    {
        pDeviceInfo = new CD3DEnumeration::D3DDeviceInfo;
        if( pDeviceInfo == NULL )
            return E_OUTOFMEMORY;
...
//-----------------------------------------------------------------------------
HRESULT CD3DEnumeration::EnumerateDeviceCombos( CD3DEnumeration::D3DDeviceInfo* pDeviceInfo, 
                                               CArrayList* pAdapterFormatList )
{
    ...
    for( UINT iaf = 0; iaf < pAdapterFormatList->Count(); iaf++ )
    {
        ...
        for( UINT ibbf = 0; ibbf < backBufferFormatArrayCount; ibbf++ )
        {
            ...
            for( UINT iiw = 0; iiw < 2; iiw++)
            {
                ...
                CD3DEnumeration::D3DDeviceCombo* pDeviceCombo = NULL;
                pDeviceCombo = new CD3DEnumeration::D3DDeviceCombo;
                ...
                pDeviceCombo->pDSMSConflictList = new CArrayList( AL_VALUE, sizeof( CD3DEnumeration::D3DDSMSConflict ) );
                pDeviceCombo->pVertexProcessingTypeList = new CArrayList( AL_VALUE, sizeof( CD3DEnumeration::VertexProcessingType ) );
...
//-----------------------------------------------------------------------------
void CD3DEnumeration::BuildDepthStencilFormatList( CD3DEnumeration::D3DDeviceCombo* pDeviceCombo )
{
...
//-----------------------------------------------------------------------------
void CD3DEnumeration::BuildMultiSampleTypeList( CD3DEnumeration::D3DDeviceCombo* pDeviceCombo )
{
...
//       multisample types.
//-----------------------------------------------------------------------------
void CD3DEnumeration::BuildDSMSConflictList( CD3DEnumeration::D3DDeviceCombo* pDeviceCombo )
{
    CD3DEnumeration::D3DDSMSConflict DSMSConflict;
...
//       and app to the given D3DDeviceCombo.
//-----------------------------------------------------------------------------
void CD3DEnumeration::BuildVertexProcessingTypeList( CD3DEnumeration::D3DDeviceInfo* pDeviceInfo, 
                                                     CD3DEnumeration::D3DDeviceCombo* pDeviceCombo )
{
    CD3DEnumeration::VertexProcessingType vpt;
...
//-----------------------------------------------------------------------------
void CD3DEnumeration::BuildPresentIntervalList( CD3DEnumeration::D3DDeviceInfo* pDeviceInfo, 
                                                CD3DEnumeration::D3DDeviceCombo* pDeviceCombo )
{
    const UINT piArray[] = { 
