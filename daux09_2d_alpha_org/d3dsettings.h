...
public:
    ...
    CD3DEnumeration::D3DAdapterInfo* pWindowed_AdapterInfo;
    CD3DEnumeration::D3DDeviceInfo* pWindowed_DeviceInfo;
    CD3DEnumeration::D3DDeviceCombo* pWindowed_DeviceCombo;
    ...
    CD3DEnumeration::VertexProcessingType Windowed_VertexProcessingType;

    UINT Windowed_PresentInterval;
    int Windowed_Width;
    int Windowed_Height;

    CD3DEnumeration::D3DAdapterInfo* pFullscreen_AdapterInfo;
    CD3DEnumeration::D3DDeviceInfo* pFullscreen_DeviceInfo;
    CD3DEnumeration::D3DDeviceCombo* pFullscreen_DeviceCombo;
    ...
    CD3DEnumeration::VertexProcessingType Fullscreen_VertexProcessingType;

    UINT Fullscreen_PresentInterval;

    CD3DEnumeration::D3DAdapterInfo* PAdapterInfo() { return IsWindowed ? pWindowed_AdapterInfo : pFullscreen_AdapterInfo; }
    CD3DEnumeration::D3DDeviceInfo* PDeviceInfo() { return IsWindowed ? pWindowed_DeviceInfo : pFullscreen_DeviceInfo; }
    CD3DEnumeration::D3DDeviceCombo* PDeviceCombo() { return IsWindowed ? pWindowed_DeviceCombo : pFullscreen_DeviceCombo; }
    ...
    CD3DEnumeration::VertexProcessingType GetVertexProcessingType() { return IsWindowed ? Windowed_VertexProcessingType : Fullscreen_VertexProcessingType; }
    void SetVertexProcessingType(CD3DEnumeration::VertexProcessingType value) { if (IsWindowed) Windowed_VertexProcessingType = value; else Fullscreen_VertexProcessingType = value; }
