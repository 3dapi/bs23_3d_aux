...
CD3DApplication* CD3DApplication::m_pD3DApp = NULL;
...
{
	CD3DApplication::m_pD3DApp	= this;
...
bool CD3DApplication::ConfirmDeviceHelper( D3DCAPS9* pCaps, INT vertexProcessingType, void* pDeviceCombo)
{
	...
	D3DFORMAT AdapterFormat = ((CD3DEnum::D3DDeviceCombo*)pDeviceCombo)->AdapterFormat;
	D3DFORMAT BackBufferFormat = ((CD3DEnum::D3DDeviceCombo*)pDeviceCombo)->BackBufferFormat;

	return SUCCEEDED( CD3DApplication::m_pD3DApp->ConfirmDevice( pCaps, dwBehavior,AdapterFormat, BackBufferFormat ) );
}
...
HRESULT CD3DApplication::ConfirmDevice( D3DCAPS9* pCaps
									   , DWORD dwBehavior
...
HRESULT CD3DApplication::Create( HINSTANCE hInstance )
{
	...
	if( m_hWnd == NULL)
	{
		...
		HMENU hMenu = NULL;//LoadMenu( m_hInst, MAKEINTRESOURCE(IDR_MENU) );
...
// Sets up m_d3dSettings with best available windowed mode, subject to
...
bool CD3DApplication::FindBestWindowedMode( bool bRequireHAL, bool bRequireREF )
{
	...
	{
		CD3DEnum::D3DAdapterInfo* pAdapterInfo = (CD3DEnum::D3DAdapterInfo*)m_d3dEnumeration.m_pAdapterInfoList->GetPtr(iai);
...
//	m_d3dSettings.Windowed_MultisampleQuality = 0;
	...
	m_d3dSettings.Windowed_VertexProcessingType = *(CD3DEnum::VertexProcessingType*)pBestDeviceCombo->pVertexProcessingTypeList->GetPtr(0);
...
// Sets up m_d3dSettings with best available fullscreen mode, subject to
// the bRequireHAL and bRequireREF constraints.  Returns false if no such
// mode can be found.
...
//	m_d3dSettings.Fullscreen_MultisampleQuality = 0;
	...
	m_d3dSettings.Fullscreen_VertexProcessingType = *(CD3DEnum::VertexProcessingType*)pBestDeviceCombo->pVertexProcessingTypeList->GetPtr(0);
...
{
	return CD3DApplication::m_pD3DApp->MsgProc( hWnd, uMsg, wParam, lParam );
}
...
HRESULT CD3DApplication::Initialize3DEnvironment()
{
	...
	DWORD behaviorFlags = 0; // TODO: throw exception
