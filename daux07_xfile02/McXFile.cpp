...
INT CMcXFile::Create(LPDIRECT3DDEVICE9 pDev, char* sFileName, void* pOriginal)
{
	HRESULT hr = 0;
	...
	// 메쉬 로드
	hr = D3DXLoadMeshFromX(sFileName, D3DXMESH_SYSTEMMEM, m_pDev
						, &AdjBuf
						, &MtlBuf
						, 0
						, &nMtl
	...
	_splitpath( sFileName, NULL, dir, NULL, NULL);
